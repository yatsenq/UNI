...
class App:
    """Головне вікно програми з графічним інтерфейсом."""
    ...
    def _build_gui(self):
        """Побудова інтерфейсу з вкладками."""
        ...
        notebook.add(tab_slae, text="  Розв'язання СЛАР  ")
        self._build_slae_tab(tab_slae)

    # =========================================================================
    #  ВКЛАДКА МАТРИЦЬ — ліва частина: введення, права частина: результат
    # =========================================================================
    def _build_matrix_tab(self, parent):
        # Головний розподіл: ліво (введення) + право (результат)
        ...
        # ---- ЛІВА ЧАСТИНА: матриця A зверху, матриця B знизу ----
        ...
        # ---- ПРАВА ЧАСТИНА: операції (сіткою) + результат ----
        ...
        # Множення на скаляр в одному рядку
    ...
    # =========================================================================
    #  ВКЛАДКА ВЕКТОРІВ — все вертикально, компактно
    # =========================================================================
    ...
    # =========================================================================
    #  ВКЛАДКА СЛАР — матриця зліва, вектор + кнопка справа
    # =========================================================================
    def _build_slae_tab(self, parent):
        ...
        # Право: вектор b + кнопка розв'язку
        ...
        ttk.Button(right_slae, text="Розв'язати методом Гауса",
                   command=self._solve_slae).pack(padx=10, pady=5, fill=tk.X)
    ...
    def _parse_matrix_from_text(self, text_widget):
        """Зчитує матрицю з текстового поля."""
    ...
    def _display_matrix_in_text(self, text_widget, matrix):
        """Відображає матрицю в текстовому полі."""
    ...
    def _parse_vector_from_entry(self, entry_widget):
        """Зчитує вектор з поля вводу (числа через пробіл)."""
    ...
    def _display_vector_in_entry(self, entry_widget, vector):
        """Відображає вектор у полі вводу."""
    ...
    def _save_result(self):
        """Зберігає текст результату у файл."""
    ...
    def _generate_random_matrix(self, which):
        """Генерує випадкову матрицю у заданому діапазоні."""
        try:
            if which == 'A':
    ...
    def _get_both_matrices(self):
        """Зчитує обидві матриці з текстових полів."""
        try:
    ...
    def _show_result(self, text):
        """Відображає результат у полі результату."""
    ...
    def _solve_slae(self):
        try:
            ...
            system = SLAE(A=a, b=b)
            x = system.solve_gauss()
            r = system.residual()

            result_text = "Розв'язок СЛАР (метод Гауса з вибором головного елемента):\n\n"
