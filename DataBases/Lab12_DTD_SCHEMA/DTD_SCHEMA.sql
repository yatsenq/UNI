...
<!ELEMENT insurance_database (persons, properties, agreements, insured_persons, insurance_objects, insurance_policies)>
<!ATTLIST insurance_database export_date CDATA #REQUIRED>

<!ELEMENT persons (person+)>
<!ELEMENT person (first_name, last_name, gender, birth_date, email?, phone_number?)>
...
<!ELEMENT property (description, value, year_of_issue?, location?)>
<!ATTLIST property id CDATA #REQUIRED currency CDATA #REQUIRED>
...
<!ELEMENT agreement (conclusion_date, total_insurance_amount, duration_months)>
...
<!ELEMENT insured (address?, phone_number?, email?, gender, birth_date)>
<!ATTLIST insured id CDATA #REQUIRED person_ref CDATA #REQUIRED>
<!ELEMENT address (#PCDATA)>

<!ELEMENT insurance_objects (insurance_object*)>
<!ELEMENT insurance_object (insured_ref, property_ref)>
...
<!ELEMENT policy (start_date, end_date, insurance_amount, insured_ref, agreement_ref)>
<!ATTLIST policy id CDATA #REQUIRED>
<!ELEMENT start_date (#PCDATA)>
<!ELEMENT end_date (#PCDATA)>
<!ELEMENT insurance_amount (#PCDATA)>
<!ELEMENT agreement_ref (#PCDATA)>
]>
